...
Scene::Scene()
{
    ...
    // Draw walls
    m_Wall = new Wall("data/white_noise.wav");
    m_Wall->setPosition(vec3::fromValues(0.0, 0.0, -10.0));
    // m_Wall1->setOrientation(vec3::fromValues(0.0, 0.0, 0.0));
    // m_Wall1->setScale(vec3::fromValues(1.0, 1.0, 1.0));
